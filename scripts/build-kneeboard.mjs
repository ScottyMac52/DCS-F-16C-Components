...
function preparedAssets() {
  return {
    ...
    tqs: dataUri(readFileSync(join(assetDir, 'viper-tqs-mission-pack-clean.png')), 'image/png'),
...
const pages = [
  ...
  hasProfile('Viper TQS') && {
    ...
    images: [{ href: assets.tqs, x: 355, y: 330, width: 490, height: 850, opacity: 0.95 }],
    callouts: [
      callout('X / Y', 'Radar cursor X / Y', 'left', [710, 580], 'gold'), callout('RX / RY', 'Range / antenna elevation', 'left', [745, 590], 'gold'),
      callout('RZ', 'Zoom view • inverted', 'left', [760, 620]), callout('BTN 1–4', 'IFF OUT • UHF • IFF IN • VHF', 'left', [685, 545]),
      callout('BTN 6', 'UNCAGE', 'left', [730, 555]), callout('BTN 7/8', 'DOGFIGHT / missile override', 'left', [715, 565]),
      callout('BTN 9/10', 'Speed brake extend / retract', 'left', [705, 575]), callout('BTN 12', 'ENABLE depress', 'left', [690, 585]),
      callout('BTN 13–16', 'DCS up / sequence / down / return', 'left', [680, 595]), callout('BTN 17', 'Chaff / flare dispense', 'left', [735, 605]),
      callout('BTN 18', 'Throttle OFF hold ↔ IDLE', 'left', [620, 650]),
      callout('BTN 22', 'Emergency stores jettison', 'right', [660, 760], 'red'), callout('BTN 23/24', 'Master arm / simulate', 'right', [625, 790], 'red'),
      callout('BTN 25–28/55', 'CMDS program selector', 'right', [515, 810]), callout('BTN 29–33/56', 'CMDS mode selector', 'right', [560, 805]),
      callout('BTN 34–37', 'RWR controls', 'right', [600, 820]), callout('BTN 38/57', 'Landing gear up / down', 'right', [455, 850], 'gold'),
      callout('BTN 39–41/58', 'Exterior-light master', 'right', [500, 845]), callout('BTN 42–44', 'Heading set controls', 'right', [555, 855]),
      callout('BTN 45/59', 'Stores CAT I / CAT III', 'right', [600, 860]), callout('BTN 46/47', 'RF normal / silent', 'right', [645, 850]),
      callout('BTN 48/61', 'Laser arm / off', 'right', [685, 845], 'red'), callout('BTN 49/62', 'Jammer source on / off', 'right', [730, 835]),
      callout('BTN 50–53/63–64', 'Autopilot roll and pitch modes', 'right', [775, 825]),
    ],
  },
